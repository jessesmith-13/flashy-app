...
export const recordTermsAcceptance = async (
  ...
  const response = await fetch(`${API_BASE}/auth/record-terms-acceptance`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
...
export const getDeckRatings = async (deckId: string, accessToken?: string) => {
  const response = await fetch(`${API_BASE}/community/decks/${deckId}/ratings`, {
    headers: {
...
export const getDeckComments = async (deckId: string) => {
  const response = await fetch(`${API_BASE}/community/decks/${deckId}/comments`, {
    headers: {
      Authorization: `Bearer ${publicAnonKey}`,
    },
  })
...
// Post comment to community deck
...
export const likeComment = async (
  ...
  const response = await fetch(`${API_BASE}/community/decks/${deckId}/comments/${commentId}/like`, {
    method: 'POST',
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
...
export const deleteDeckComment = async (
  ...
  const response = await fetch(`${API_BASE}/moderation/decks/${deckId}/comments/${commentId}`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Get all flagged content (Moderator only)
export const getFlags = async (
  ...
  const response = await fetch(`${API_BASE}/moderation/flags?${params.toString()}`, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
  })
...
// Update Flag Status (Moderator only)
export const updateFlagStatus = async (
  ...
  const response = await fetch(`${API_BASE}/moderation/flags/${flagId}`, {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Escalate flag ticket (Moderator only)
export const escalateFlag = async (
  accessToken: string,
  flagId: string,
  reason: string
) => {
  const response = await fetch(`${API_BASE}/moderation/flags/${flagId}/escalate`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Warn user for flagged content (Moderator only)
...
// Resolve a flagged item (Moderator only)
...
// Ticket System API (for Flag Management) (Moderator only)
...
export const getTicketComments = async (accessToken: string, ticketId: string) => {
  const response = await fetch(`${API_BASE}/moderatation/tickets/${ticketId}/comments`, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
  })
...
// Post comment to a flag ticket (Moderator only)
export const addTicketComment = async (
  ...
  const response = await fetch(`${API_BASE}/moderation/tickets/${ticketId}/comments`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Get ticket actions (Moderator only)
export const getTicketActions = async (accessToken: string, ticketId: string) => {
  const response = await fetch(`${API_BASE}/moderation/tickets/${ticketId}/actions`, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
  })
...
export const updateTicketStatus = async (
  ...
  const response = await fetch(`${API_BASE}/moderation/tickets/${ticketId}/status`, {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Assign ticket (Moderator only)
export const assignTicket = async (
  accessToken: string,
  ticketId: string,
  moderatorId: string
) => {
  const response = await fetch(`${API_BASE}/moderation/tickets/${ticketId}/assign`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Get all moderators (Moderator only)
...
// Flag/Report API (might need to adjust endpoint to /moderation/flags based on which dupe to keep)
...
// Delete a community deck (Superuser only) (dupe?)
export const deleteCommunityDeck = async (
  accessToken: string,
  communityDeckId: string,
  reason: string
) => {
  const response = await fetch(`${API_BASE}/admin/community/decks/${communityDeckId}`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Delete a community card (Superuser only) (dupe?)
export const deleteCommunityCard = async (
  ...
  const response = await fetch(`${API_BASE}/admin/community/decks/${communityDeckId}/cards/${cardId}`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Delete a deck (Superuser only) (dupe?)
...
// Delete a card (Superuser only) (dupe?)
export const deleteCard = async (
  ...
  const response = await fetch(`${API_BASE}/admin/decks/${deckId}/cards/${cardId}`, {
    method: 'DELETE',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Feature a community deck (Superuser only)
export const toggleCommunityDeckFeatured = async (
  accessToken: string,
  communityDeckId: string
) => {
  const response = await fetch(`${API_BASE}/admin/community/decks/${communityDeckId}/featured`, {
    method: 'PATCH',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
// Generate text with spech with ai
...
export const createCheckoutSession = async (accessToken: string, planType: 'monthly' | 'annual' | 'lifetime') => {
  const response = await fetch(`${API_BASE}/subscriptions/checout`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
export const verifyPayment = async (accessToken: string, sessionId: string) => {
  const response = await fetch(`${API_BASE}/subscriptions/verify-payment`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
...
export const cancelSubscription = async (accessToken: string) => {
  const response = await fetch(`${API_BASE}/subscriptions/cancel-subscription`, {
    method: 'POST',
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
...
export const changeSubscriptionPlan = async (accessToken: string, newPlan: 'monthly' | 'annual' | 'lifetime') => {
  const response = await fetch(`${API_BASE}/subscriptions/change-subscription-plan`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${accessToken}`,
