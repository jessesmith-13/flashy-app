    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={onSubmit} className="space-y-4 mt-4 pb-4">
          {/* Added scrolling and bottom padding */}
          <div>
          ...
          {category && (
            <div>
              ...
              <Select value={subtopic} onValueChange={onSubtopicChange}>
                ...
                <SelectContent>
                  {[
                    ...(DECK_CATEGORIES.find((c) => c.category === category)
                      ?.subtopics || []),
                  ]
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                onDifficultyChange(value === "none" ? "" : value)
              }
            >
              <SelectTrigger className="mt-1">
          ...
          <div>
            ...
            <Select
              value={frontLanguage || "none"}
              onValueChange={(value) =>
                onFrontLanguageChange?.(value === "none" ? "" : value)
              }
            >
              <SelectTrigger className="mt-1">
          ...
          <div>
            ...
            <Select
              value={backLanguage || "none"}
              onValueChange={(value) =>
                onBackLanguageChange?.(value === "none" ? "" : value)
              }
            >
              <SelectTrigger className="mt-1">
                <SelectValue placeholder="Select a language..." />
