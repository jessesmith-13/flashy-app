...
import { UnsplashAttribution } from "@/components/AI/UnsplashAttribution";
      ...
      <div className="flex items-start justify-between gap-4">
        <div
          className={`flex-1 space-y-2 sm:space-y-3 ${
            selectionMode ? "pl-10" : "pr-12 sm:pr-16"
          }`}
        >
              ...
              <div className="mt-2 rounded-lg overflow-hidden border">
                ...
                {card.frontImageAttribution && (
                  <UnsplashAttribution
                    ...
                    className="mt-1 px-2 py-1 bg-gray-50 dark:bg-gray-900/50 rounded text-xs"
                  />
                )}
              </div>
            )}
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-1">
                    {card.correctAnswers.map((answer, idx) => (
                      <li
                        key={idx}
                        className="text-gray-900 dark:text-gray-100 break-words flex items-start gap-1"
                      >
                ...
                <div>
                  ...
                  <ul className="text-sm space-y-1">
                    {card.incorrectAnswers.map((option, idx) => (
                      <li
                        key={idx}
                        className="text-gray-600 dark:text-gray-400 break-words flex items-start gap-1"
                      >
