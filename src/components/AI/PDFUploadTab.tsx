...
export function PDFUploadTab({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      {/* Custom Instructions */}
      <div>
        <Label htmlFor="pdf-customInstructions-client">Custom Instructions (Optional)</Label>
        <Textarea
      ...
      <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-3">
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            onChange={(e) => {
              ...
              onCardTypesChange({ ...cardTypes, classicFlip: e.target.checked })
            }}
            className="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500"
          />
          <label htmlFor="pdf-classicFlip-client" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
            Classic Flip
          </label>
        </div>
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            onChange={(e) => {
              ...
              onCardTypesChange({ ...cardTypes, multipleChoice: e.target.checked })
            }}
            className="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500"
          />
          <label htmlFor="pdf-multipleChoice-client" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
            Multiple Choice
          </label>
        </div>
        ...
        <div className="flex items-center gap-3">
          <input
            ...
            className="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500"
          />
          <label htmlFor="pdf-typeAnswer-client" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
            Type Answer
          </label>
        </div>
        ...
        <div className="flex items-center gap-3 opacity-50 cursor-not-allowed">
          <input
            ...
            className="w-4 h-4 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500"
          />
          <label htmlFor="includeImages-client" className="text-sm text-gray-500 dark:text-gray-500">
      ...
      <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg p-4">
        <p className="text-xs text-green-800 dark:text-green-400">
          ✨ <strong>Client-side processing:</strong> Your PDF is processed locally in your browser for speed and privacy. Only the extracted text is sent to AI.
        </p>
      </div>
