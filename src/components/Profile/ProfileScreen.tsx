...
export function ProfileScreen() {
  ...
  useEffect(() => {
    ...
    const avgScore =
      totalSessions > 0
        ? studySessions.reduce((sum, session) => sum + session.score, 0) /
          totalSessions
        : 0;
    ...
    if (sortedDayTimestamps.length > 0) {
      ...
      if (
        mostRecentStudyTimestamp === todayTimestamp ||
        mostRecentStudyTimestamp === yesterdayTimestamp
      ) {
        ...
        console.log("📊 Streak calculation:", {
          ...
          uniqueDays: sortedDayTimestamps.map((ts) =>
    ...
    const cardsReviewed = studySessions.reduce(
        ...
        <div className="max-w-6xl mx-auto overflow-x-hidden">
          ...
          >
            <TabsList className="w-full flex justify-center mb-6">
              <TabsTrigger value="stats" className="flex-none">
              ...
              <TabsTrigger value="friends" className="flex-none">
