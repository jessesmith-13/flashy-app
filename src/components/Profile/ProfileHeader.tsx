      ...
      <div className="flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex-1 text-center md:text-left">
          <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
            <h1 className="text-3xl text-gray-900 dark:text-gray-100">{user?.displayName || user?.name}</h1>
            <button 
              onClick={onEditClick}
          ...
          <div className="flex flex-wrap gap-4 justify-center md:justify-start mt-4">
            <div className="flex items-center gap-2 px-4 py-2 bg-orange-50 dark:bg-orange-900/30 rounded-lg">
              ...
              <span className="text-gray-900 dark:text-gray-100">{studyStreak} day streak</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-emerald-50 dark:bg-emerald-900/30 rounded-lg">
              ...
              <span className="text-gray-900 dark:text-gray-100">{unlockedAchievements}/{totalAchievements} achievements</span>
            </div>
