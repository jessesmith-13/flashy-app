          ...
          {!shareUrl ? (
            <div className="text-center py-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Generate a shareable link that allows anyone to view and study this deck
              </p>
              <Button
            ...
            <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'url' | 'qr')} className="w-full">
              ...
              <TabsContent value="url" className="space-y-4 mt-4">
                <div className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                  <p className="text-xs text-gray-600 dark:text-gray-400 mb-2">Share URL:</p>
