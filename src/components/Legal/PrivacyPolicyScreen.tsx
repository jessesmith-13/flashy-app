            ...
            <div className="space-y-8 text-gray-900 dark:text-gray-100">
              <div className="pb-6 border-b border-gray-200 dark:border-gray-700">
                <p className="text-base leading-relaxed">
                  Flashy ("we", "us", "our") respects your privacy. This Privacy
                  Policy explains what data we collect, why, and how we use it.
                </p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-700 dark:text-gray-300">
                    When generating cards using AI:
                  </p>
                  <ul className="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300">
                    <li>Prompt text</li>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    <strong className="text-gray-900 dark:text-gray-100">
                      Stripe or App Store / Google Play
                    </strong>{" "}
                    (payment processing)
                  </li>
                  <li>
              ...
              <div className="space-y-3">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  Flashy is not directed to children under 13.
                  <br />
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 list-disc list-inside text-gray-700 dark:text-gray-300">
                  ...
                  <li>
                    We comply with GDPR and similar regulations where required
                  </li>
                </ul>
              </div>
