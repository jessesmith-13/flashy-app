          ...
          <AlertDialogDescription className="space-y-3 pt-2">
            ...
            {isUpgrade && (
              <p className="text-sm text-gray-600 dark:text-gray-400">
                You will be charged the prorated difference immediately, and
                your billing will be updated to the new plan.
              </p>
            )}

            {isDowngrade && (
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Your plan will be changed at the end of your current billing
                period. You'll keep your current benefits until then.
              </p>
            )}

            {newPlan === "lifetime" && (
              <p className="text-sm text-emerald-600 dark:text-emerald-400">
                Upgrading to Lifetime will give you permanent access to all
                premium features with no recurring charges!
              </p>
            )}
          </AlertDialogDescription>
        </AlertDialogHeader>
