          ...
          <div className="max-w-4xl mx-auto p-4 lg:p-8">
            <div className="bg-red-50 dark:bg-red-900/20 rounded-2xl p-8 text-center border-2 border-red-200 dark:border-red-700">
              ...
              <p className="text-red-700 dark:text-red-300 mb-6">
                You don't have permission to access this page. Moderator privileges are required.
              </p>
              <Button
        ...
        <div className="max-w-4xl mx-auto p-4 lg:p-8">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h1 className="text-2xl lg:text-3xl text-gray-900 dark:text-gray-100">Moderator Tools</h1>
                <p className="text-gray-600 dark:text-gray-400">Manage community content and reports</p>
              </div>
            </div>
          </div>
