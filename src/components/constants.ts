import { FlipVertical, CheckCircle, Keyboard, type LucideIcon } from 'lucide-react'
import type { CardType } from '../../store/useStore'

export const CARD_TYPES: { value: CardType; label: string; icon: LucideIcon; description: string }[] = [
