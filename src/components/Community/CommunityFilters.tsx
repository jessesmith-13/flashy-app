      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="w-full sm:w-auto">
          <Button
            ...
            className={`w-full ${showFeaturedOnly ? 'bg-purple-600 hover:bg-purple-700 text-white' : 'border-purple-300 dark:border-purple-700 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20'}`}
          >
            <Star className={`w-4 h-4 mr-2 ${showFeaturedOnly ? 'fill-current' : ''}`} />
        ...
        <div className="w-full sm:w-auto">
          <Button
            ...
            className={`w-full ${showFlashyDecksOnly ? 'bg-emerald-600 hover:bg-emerald-700 text-white' : 'border-emerald-300 dark:border-emerald-700 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20'}`}
          >
