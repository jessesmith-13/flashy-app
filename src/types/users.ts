...
export interface User {
  ...
  userRole?: string | null; // Custom user role (e.g., "teacher", "student")
  userRoleVerified?: boolean; // Whether the custom user role has been verified
  verifiedAt?: string | null; // Timestamp when the user's email was verified
